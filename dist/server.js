...
var web_hooks_1 = require("./web-hooks");
var next_build_1 = require("next/dist/cli/next-build");
var path_1 = __importDefault(require("path"));
var app = (0, express_1.default)();
var PORT = Number(process.env.POST) || 3000;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                app.post('/api/webhook/stripe', webHookMiddleware, web_hooks_1.stripeWebHookHandler);
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, (0, next_build_1.nextBuild)(path_1.default.join(__dirname, '../'))];
                                case 1:
                                    _a.sent();
                                    process.exit();
                                    return [2 /*return*/];
