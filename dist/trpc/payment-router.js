...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure
        .input(validators_1.PaymentSessionValidator)
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        filteredProducts = products
                            .filter(function (p) { return Boolean(p.priceId); });
                        return [4 /*yield*/, payload.create({
                                collection: 'orders',
                                data: {
                                    _isPaid: false,
                                    products: filteredProducts.map(function (p) { return p.id; }),
                                    user: user.id,
                                }
                            })];
                    case 3:
    ...
    pullOrderStatus: trpc_1.privateProcedure
        .input(validators_1.OrderStatusValidator)
        .query(function (_a) {
        var input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
