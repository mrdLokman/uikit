...
const Page = ()=>{
    ...
    return (
        <div className="bg-white">
            <div className="mx-auto max-w-2xl px-4 pb-24 pt-36 sm:px-6 lg:px-8 lg:max-w-7xl">
                                        ...
                                        <div className="relative w-24 h-24">
                                            {typeof image !== 'string' && image.url? (
                                                <Image
                                                    ...
                                                    alt="product image"
                                                    fill
                                                    className="h-full w-full rounded-md object-cover object-center sm:h-48 sm-w48"
                                                />
                                            ): null}
                                        </div>
                                    </div>
